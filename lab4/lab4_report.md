...
**BookViewer** – AI-ассистент по подбору книги. Пользователь выбирает жанр и описывает желаемую книгу промптом. По итогу пользователь получает две рекомендации.  
**Функционал**
