...
**Ресурсы**
Разделение frontend и backend, добавление кеширования и очереди для асинхронных задач. Firestone меняется на Cloud SQL, добавляется Cloud Pub/Sub для оркестрации асинхронной обработки длинных промптов и предотвращения таймаутов и Cloud Monitoring/Logging – подключаем детальный мониторинг и алертинг
