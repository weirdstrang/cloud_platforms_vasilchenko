...
3. Продумать три состояния приложения составить схему инфраструктуры для каждого в draw.io  
  3.1. Начальное  
...
7. Выбрать оптимальное решение изходя из предполагаемых нагрузок
8. Подвести итоги
...
**BookViewer** – AI-ассистент по подбору книги. Пользователь перечисляет любимые жанры и описывает настроение желаемой книги промптом. По итогу пользователь получает две рекомендации и имеет возможность перегенерировать ответ.
**Функционал**
